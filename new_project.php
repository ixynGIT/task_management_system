    ...
    <div class="row">
    	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="priority_id" id="priority_id" class="custom-select custom-select-sm" required/>
						<option value="1" <?php echo isset($priority_id) && $priority_id == 1 ? 'selected' : '' ?>>Important!</option>
						<option value="2" <?php echo isset($priority_id) && $priority_id == 2 ? 'selected' : '' ?>>Moderate</option>
						<option value="3" <?php echo isset($priority_id) && $priority_id == 3 ? 'selected' : '' ?>>Least</option>
					</select>
				</div>
			</div>
    </div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					console.log($(this)[0])
					setTimeout(function(){
						location.href = 'index.php?page=new_project'
					},200000)
				}
			}
		})
