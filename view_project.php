						...
						<div class="col-md-6">
							...
							<dl>
								...
								<dt>
									...
									<a class="btn btn-primary bg-gradient-primary btn-sm text-white text-decoration-none" href="./index.php?page=edit_project&id=<?php echo $_GET['id'] ?>"><i class="fa fa-edit"></i>Edit Project</a>
									<a class="btn btn-danger bg-gradient-danger btn-sm text-white text-decoration-none delete_project" type="button" href="javascript:void(0)" data-id="<?php echo $_GET['id'] ?>"><i class="fa fa-trash"></i> Delete Project</a>
								<?php endif; ?>
								</dt>
							</dl>
						</div>
...
<script>
	$('#new_task').click(function(){
		uni_modal("<strong>New Task For: <?php echo ucwords($name) ?></strong>","manage_task.php?pid=<?php echo $id ?>","mid-large")
	})
	...
	$('#new_productivity').click(function(){
		uni_modal("<i class='fa fa-plus'></i> <strong>New Progress: <?php echo $name?></strong>","manage_progress.php?pid=<?php echo $id?>",'large')
	})
