...
Class Action {
	...
	function delete_procedure1(){
		extract($_POST);
		$delete = $this->db->query("CALL DeleteProject($id)");
		if($delete){
			return 1;
		}
	}
	function delete_procedure2(){
		extract($_POST);
		$delete = $this->db->query("CALL DeleteTask($id)");
		if($delete){
			return 1;
		}
	}
	...
	function save_progress(){
		...
		$dur = abs(strtotime($date." " .$end_time)) - abs(strtotime($date." ".$start_time));
		$dur = $dur / (60 * 60);
