			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php
							   if($prio[$row['priority_id']] =='IMPORTANT!'){
							  	echo "<span class='badge rounded-pill bg-danger'>{$prio[$row['priority_id']]}</span>";
							  }elseif($prio[$row['priority_id']] =='MODERATE'){
							  	echo "<span class='badge rounded-pill bg-warning'>{$prio[$row['priority_id']]}</span>";
							  }elseif($prio[$row['priority_id']] =='LEAST'){
							  	echo "<span class='badge rounded-pill bg-secondary'>{$prio[$row['priority_id']]}</span>";
							  }
